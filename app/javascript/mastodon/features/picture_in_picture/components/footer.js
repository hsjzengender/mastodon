  ...
  render () {
    ...
    return (
      <div className='picture-in-picture__footer'>
        ...
        <IconButton className={classNames('status__action-bar-button', { reblogPrivate })} disabled={!publicStatus && !reblogPrivate}  active={status.get('reblogged')} title={reblogTitle} icon={icons.reblog} onClick={this.handleReblogClick} counter={status.get('reblogs_count')} />
        <IconButton className='status__action-bar-button star-icon' animate active={status.get('favourited')} title={intl.formatMessage(messages.favourite)} icon={icons.favourite} onClick={this.handleFavouriteClick} counter={status.get('favourites_count')} />
